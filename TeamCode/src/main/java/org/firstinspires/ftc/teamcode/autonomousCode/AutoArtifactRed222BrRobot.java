...
@Autonomous(name="AutoArtifactRed222BrRobot", group = "Autonomous")
public class AutoArtifactRed222BrRobot extends OpMode {
    ...
    public void buildPaths(){
        Path1 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(122.624, 122.292), new Pose(102.573, 102.242))
                )
        ...
        Path2 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(102.573, 102.242), new Pose(102.904, 84.000))
                )
        ...
        Path3 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(102.904, 84.000), new Pose(130.909, 84.000))
                )
        ...
        Path4 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(130.909, 84.000), new Pose(102.573, 102.242))
                )
        ...
        Path5 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(102.573, 102.242), new Pose(102.573, 59.600))
                )
                .setLinearHeadingInterpolation(Math.toRadians(45), Math.toRadians(0))
                .build();
        ...
        Path6 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(102.573, 59.600), new Pose(130.909, 59.600))
                )
                .setTangentHeadingInterpolation()
                .build();
        ...
        Path7 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(130.909, 59.600), new Pose(97.105, 114.173))
                )
    ...
    public void init(){
        ...
        buildPaths();
        follower.setStartingPose(new Pose(122.624, 122.292, Math.toRadians(45)));
        follower.setMaxPower(maxSpeed);
    }
