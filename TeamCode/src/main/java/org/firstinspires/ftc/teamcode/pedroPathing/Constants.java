...
public class Constants {
    public static FollowerConstants followerConstants = new FollowerConstants() //Weight Declaration
            ...
            .lateralZeroPowerAcceleration(-63.34572)
    ...
    public static DriveEncoderConstants localizerConstants = new DriveEncoderConstants()
            .forwardTicksToInches(0.012) //Insert ticks (push robot 2 inches) 0.0083 0.0083535207 0.0091492 0.01175
            .strafeTicksToInches(0.0092)//Insert ticks (push robot 2 inches)0.0022 0.0092
            .turnTicksToInches(0.018)  //Insert ticks (rotate robot full counterclockwise 1 time)0.01795 0.022
